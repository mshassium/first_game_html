...
| U-06 | Слот под карту | `ui/slot_card.png` | 2026-07-26 | OpenAI | 1 | Отклонён, нужна перегенерация |
| U-09 | Урна сброса | `ui/discard_urn.png` | 2026-07-26 | OpenAI | 1 | Годится с тёплой коррекцией |
| U-08 | Стопка колоды | `ui/deck_stack.png` | 2026-07-26 | OpenAI | 1 | Отклонён, чужая рубашка |
